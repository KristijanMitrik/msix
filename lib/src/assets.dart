...
class Assets {
  ...
  Future<void> createIcons() async {
    ...
    if (logoPath != null) {
      ...
      Future<void> generateIcon(String name, _Size size, {double scale = 1}) async {
        int scaledWidth = (size.width * scale).ceil();
        int scaledHeight = (size.height * scale).ceil();
        Interpolation interpolation =
            scaledWidth < 200 || scaledHeight < 200 ? Interpolation.average : Interpolation.cubic;
      ...
      await Future.wait([
        Isolate.run(() async {
          await Future.wait([
            ...
            generateIcon('Square150x150Logo', const _Size(150, 150), scale: 1.25),
            generateIcon('Square150x150Logo', const _Size(150, 150), scale: 1.5),
        ...
        Isolate.run(() async {
          await Future.wait([
            ...
            generateIcon('Square44x44Logo.targetsize-256', const _Size(256, 256)),
        ...
        Isolate.run(() async {
          await Future.wait([
            // unplated targetsize
            generateIcon('Square44x44Logo.altform-unplated_targetsize-16', const _Size(16, 16)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-24', const _Size(24, 24)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-32', const _Size(32, 32)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-48', const _Size(48, 48)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-256', const _Size(256, 256)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-20', const _Size(20, 20)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-30', const _Size(30, 30)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-36', const _Size(36, 36)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-40', const _Size(40, 40)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-60', const _Size(60, 60)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-64', const _Size(64, 64)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-72', const _Size(72, 72)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-80', const _Size(80, 80)),
            generateIcon('Square44x44Logo.altform-unplated_targetsize-96', const _Size(96, 96)),
            // light unplated targetsize
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-16', const _Size(16, 16)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-24', const _Size(24, 24)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-32', const _Size(32, 32)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-48', const _Size(48, 48)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-256', const _Size(256, 256)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-20', const _Size(20, 20)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-30', const _Size(30, 30)),
          ]);
        }),
        Isolate.run(() async {
          await Future.wait([
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-36', const _Size(36, 36)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-40', const _Size(40, 40)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-60', const _Size(60, 60)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-64', const _Size(64, 64)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-72', const _Size(72, 72)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-80', const _Size(80, 80)),
            generateIcon(
                'Square44x44Logo.altform-lightunplated_targetsize-96', const _Size(96, 96)),
            // SplashScreen
            generateIcon(
              'SplashScreen',
              const _Size(620, 300),
  ...
  Future<void> _copyDefaultsIcons() async => await Directory(_config.defaultsIconsFolderPath)
  ...
  Future<void> copyVCLibsFiles() async {
    ...
    await Directory(p.join(_config.msixAssetsPath, 'VCLibs', _config.architecture))
  ...
  Future<void> copyContextMenuDll(String dllPath) async {
    ...
    await File(dllPath).copy(p.join(_config.buildFilesFolder, p.basename(dllPath)));
  }
  ...
  Future<void> cleanTemporaryFiles({clearMsixFiles = false}) async {
    ...
    await Future.wait([
      ...[
        ...
        ..._config.contextMenuConfiguration?.comSurrogateServers
                ...
                .toList() ??
            []
      ].map((fileName) async => await File(p.join(buildPath, fileName)).deleteIfExists()),
    ...
    if (clearMsixFiles) {
      await Future.wait([
        ...['installCertificate.ps1', 'InstallTestCertificate.exe', 'test_certificate.pfx']
            .map((fileName) async => await File(p.join(buildPath, fileName)).deleteIfExists()),
      ]);
    }
  }
